...
class ReflexAgent(Agent):
  ...
  def evaluationFunction(self, currentGameState, action):
    ...
    distanceFromGhost = manhattanDistance(newPos,newGhostStates[0].getPosition())

    if successorGameState.isWin():
        return 10000

    if newScaredTimes[0] > 2:
      distanceFromGhost = - distanceFromGhost
    ghostScore = self.getRec(distanceFromGhost) * 50
